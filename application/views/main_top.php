...
<style>body{height:100%;background:#fff;}</style>
<div id="main_top" style="background:#fff;"><p style="color:rgb(110,181,117);font-size:26px;font-family:微软雅黑;padding-left:40px;">Seo Tools</p></div>
<!--<div id="main_top">
